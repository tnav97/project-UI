...
export class PartnerComponent {
  ...
  ngOnInit(): void {
    ...
    this.getSuperAdminapartnerData();
    this.getQueryParams();
  }
  ...
  getSuperAdminapartnerData() {
    this.superAdminService.getAllSkillPartner().subscribe((data) => {
  ...
  add(): void {
    this.router.navigate(['superadmin/addnew-sp'], { queryParams: { type: 'new' } });
  }

  edit(id: string): void {
    this.router.navigate(['superadmin/addnew-sp'], { queryParams: { clientId: id, type: 'edit' } });
  }

  preview(id: string): void {
    this.router.navigate(['superadmin/addnew-sp'], { queryParams: { clientId: id, type: 'preview' } });
  }
