...
@Component({
  selector: 'app-skillpartner-list-item',
  templateUrl: './skillpartner-list-item.component.html',
  styleUrls: ['./skillpartner-list-item.component.scss'],
})
export class SkillpartnerListItemComponent implements OnInit {
  jobId: string;
  jobTitle: string;
  skillOwnerId: number;
  ...
  candidateInterviewDetails(skillOwnerId: number) {
    ...
    this.skillseekerContractsService.getListsOfContractDetails(skillOwnerId).subscribe((res) => {
